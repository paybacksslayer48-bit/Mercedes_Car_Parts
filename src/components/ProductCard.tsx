...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  const getCategoryLabel = (cat: string) => {
    const labelsEn: { [key: string]: string } = {
      wheels: 'Forged Rims Set',
      interiors: 'Luxury Interiors',
      engines: 'Performance Engines',
      optics: 'Adaptive Optics',
      bodykits: 'AMG Aero Bodykits',
            ...
            {compatibility === 'compatible' ? (
              <>
                ...
                <span className="text-zinc-950 font-black font-mono tracking-wide">
                  COMPATIBLE WITH {selectedModel.toUpperCase()}
                </span>
              ...
              <>
                ...
                <span className="text-zinc-500 font-mono font-bold tracking-wide">
                  REQUIRES SCN FITMENT DIAGNOSIS
                </span>
