  ...
  const getStatusDetails = (status: Order['status']) => {
    const details = {
      pending_verification: {
        label: { en: 'EPC Verification' },
        color: 'bg-zinc-100 text-zinc-800 border-zinc-250',
        desc: { en: 'Our engineer is matching original Mercedes parts against your chassis catalog.' }
      },
      parts_found: {
        label: { en: 'Photos Prepared' },
        color: 'bg-zinc-100 text-zinc-900 border-zinc-300 font-bold',
        desc: { en: 'Components are located in storage. Live condition pictures sent via WhatsApp.' }
      },
      ready_for_dispatch: {
        label: { en: 'Fragile Packaging' },
        color: 'bg-zinc-900 text-white border-zinc-950',
        desc: { en: 'Parts wrapped in shockproof bubble-lining on wooden custom pallets.' }
      },
      dispatched: {
        label: { en: 'Shipped (DHL Freight)' },
        color: 'bg-zinc-950 text-white border-zinc-950 font-bold tracking-widest',
        desc: { en: 'On the way to your address. Tracking number registered on carrier site.' }
      },
      completed: {
        label: { en: 'Handed Over & Coded' },
        color: 'bg-zinc-50 text-zinc-900 border-zinc-300 font-bold',
        desc: { en: 'Components handed over. Retrofitting installation completed with SCN coding!' }
      }
    };
            ...
            <div className="p-6 border-b border-zinc-200 bg-zinc-50 flex justify-between items-center">
              <div>
                ...
                <p className="text-[9px] text-zinc-500 font-mono uppercase tracking-wider">
                  Real-time logistical milestones of original components verification
                </p>
              </div>
              <button
                onClick={onClose}
              ...
              <div className="flex gap-2">
                <div className="relative flex-grow">
                  ...
                  <input
                    ...
                    placeholder="Filter by Order ID or VIN number..."
                        ...
                        >
                          <div className="space-y-1">
                            ...
                            <p className="text-xs font-bold text-zinc-650 font-sans">
                              ...
                              <span className="font-mono text-[11.5px] text-zinc-900 font-bold uppercase select-all">VIN: {order.vin}</span>
                            </p>
                          </div>
