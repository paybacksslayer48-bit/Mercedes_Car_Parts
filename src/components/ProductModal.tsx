            ...
            <div className="w-full md:w-1/2 p-7 md:p-9 bg-zinc-50/50 flex flex-col justify-between border-b md:border-b-0 md:border-r border-zinc-200 max-h-[45vh] md:max-h-[inherit] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4 pt-6 text-xs font-mono text-zinc-600 tracking-wider">
                <div className="p-3.5 rounded-xl bg-white border border-zinc-200 flex items-start gap-3 shadow-sm">
                  ...
                  <div>
                    <span className="block font-bold text-zinc-900 uppercase">Part Warranty</span>
                    <span className="text-zinc-400">12 Months</span>
                  </div>
                </div>
                ...
                <div className="p-3.5 rounded-xl bg-white border border-zinc-200 flex items-start gap-3 shadow-sm">
                  ...
                  <div>
                    <span className="block font-bold text-zinc-900 uppercase">DHL Freight</span>
                    <span className="text-zinc-400">Insured Pallet</span>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="space-y-3 font-mono text-xs">
                    ...
                    <div className="flex justify-between py-2 border-b border-zinc-150">
                      <span className="text-zinc-400 uppercase tracking-wider text-[10px] font-bold">Manufacturer OEM Code</span>
                ...
                <div className="space-y-4 p-5 rounded-2xl bg-zinc-50 border border-zinc-200">
                  <div className="flex items-center justify-between">
                    <label className="text-[11px] font-mono text-zinc-500 uppercase tracking-widest block font-black">
                      Quick Fitment Catalog Match
                    </label>
                    <span className="text-[10px] text-zinc-400 font-mono tracking-wider font-semibold">Mercedes-Benz</span>
                  </div>
                  ...
                  >
                    <option value="">-- Select custom chassis model --</option>
                  ...
                  {/* VIN EPC match database check */}
                  <div className="pt-3 border-t border-zinc-200">
                    <form onSubmit={handleVerifyVin} className="flex gap-2">
                      <input
                        type="text"
                        placeholder="Enter VIN for EPC matching check"
                        value={typedVin}
                    ...
                    {vinVerified !== null && (
                      ...
                      >
                        ...
                        <span className="font-mono tracking-wider uppercase font-black">
                          100% Fitment Certified on Mercedes EPC Database!
                        </span>
                      </motion.div>
                    )}
                  </div>
