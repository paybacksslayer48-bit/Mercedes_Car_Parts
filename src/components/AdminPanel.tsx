...
export const AdminPanel: React.FC<AdminPanelProps> = ({
  ...
  const [newItemCategory, setNewItemCategory] = useState<Product['category']>('wheels');
  ...
  const [newItemSpecs, setNewItemSpecs] = useState('Size: 19 Inches, Material: Forged Alloy');
  const [newItemCompatibleModels, setNewItemCompatibleModels] = useState<string[]>(['S-Class (W222/W223)']);
  ...
  const getStatusLabel = (status: Order['status']) => {
    const labels: { [key in Order['status']]: string } = {
      pending_verification: 'Pending SCN Match',
      parts_found: 'Photos Ready (WhatsApp)',
      ready_for_dispatch: 'Fragile Boxing Completed',
      dispatched: 'DHL Shipped Out',
      completed: 'Closed & SCN Code Flashed'
    };
          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-black tracking-widest uppercase text-white flex items-center gap-2">
                    ...
                    <span>MERCEDES_PARTS SECURE ADMIN CHAMBER</span>
                  </h2>
                  <p className="text-[9px] font-mono text-zinc-500 uppercase tracking-widest">
                    EPC Diagnostics, Parts Allocation holds, and logistics management
                  </p>
                </div>
              </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-mono bg-zinc-900/40 p-4 rounded-xl border border-zinc-900">
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="text-zinc-200 flex items-start gap-1.5 text-[11px] font-black">
                                ...
                                <span className="select-all leading-normal">{order.address || 'Milan Depot Pick-up'}</span>
                              </p>
                ...
                <div className="space-y-10">
                  ...
                  <form onSubmit={handleCreateProduct} className="p-6 bg-zinc-950 rounded-2xl border border-zinc-850 space-y-5">
                    <h3 className="text-xs font-mono font-black uppercase text-white tracking-widest border-b border-zinc-850 pb-2.5 flex items-center gap-2">
                      ...
                      <span>Input New Premium OEM Catalogue Card</span>
                    </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[9px] font-mono text-zinc-400 uppercase tracking-wider block font-bold">
                          Mercedes Parts OEM Serial *
                        </label>
                        <input
                          type="text"
                          required
                          placeholder="E.g. A2234011700"
                          value={newItemOem}
                      ...
                      <div className="space-y-1.5">
                        ...
                        >
                          <option value="wheels">Forged Wheels Set</option>
                          <option value="interiors">Luxury Interiors</option>
                          <option value="engines">Motors & Tuning</option>
                          <option value="optics">Adaptive Optics</option>
                          <option value="bodykits">AMG Bodykits</option>
                          <option value="electronics">OEM Electronics</option>
                        </select>
                      </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        type="text"
                        placeholder="Size: 21 Inches, Material: Forged 6061 Forged, Finish: Gloss Diamond"
                        value={newItemSpecs}
                    ...
                    <div className="space-y-2">
                      <label className="text-[9px] font-mono text-zinc-400 uppercase tracking-wider block font-bold">
                        Compatible Mercedes Chassis Models Select *
                      </label>
            ...
            <div className="p-4 border-t border-zinc-800 bg-zinc-950 flex flex-col sm:flex-row items-center justify-between text-[11px] font-mono text-zinc-500 shrink-0 select-none">
              ...
              <span className="flex items-center gap-1">
                ...
                <span>EPC ACCESS SECURE LEVEL 3</span>
              </span>
            </div>
