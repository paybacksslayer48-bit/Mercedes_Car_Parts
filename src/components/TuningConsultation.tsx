...
import { X, Upload, Check, Compass, Info } from 'lucide-react';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-xl bg-white border border-zinc-200 rounded-lg overflow-hidden shadow-2xl flex flex-col z-10 max-h-[92vh]"
          >
            {/* Header banner */}
            <div className="p-6 border-b border-zinc-200 bg-zinc-50 flex justify-between items-center">
              <div className="space-y-0.5">
                <h3 className="text-base font-black tracking-tight text-zinc-950 uppercase flex items-center gap-2">
                  ...
                  <span>Detailing Customization Console</span>
                </h3>
                <p className="text-[9px] font-mono text-zinc-500 uppercase tracking-widest leading-none">
                  SCN programming • AMG retrofits • custom assemblies
                </p>
              </div>
              <button
                onClick={onClose}
                ...
                <form onSubmit={handleConsultSubmit} className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between items-baseline">
                      <label className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider block font-bold">
                        Chassis Part Reference Pictures
                      </label>
                  ...
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider block font-bold">
                      Specification & retrofitting details
                    </label>
                    <textarea
                      rows={3}
                      required
                      placeholder="List desired retrofitting, software configuration requirements or SCN modifications..."
                  ...
                  <div className="pt-4 border-t border-zinc-200 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                    <p className="text-[9px] text-zinc-400 leading-normal max-w-xs font-mono">
                      Our Lead Detailing Engineer will formulate WDB compatible SCN updates and verify the matching OEM parts catalogue within 2 hours.
                    </p>

                    <button
                      type="submit"
                      disabled={!customerName || !vin || !whatsapp || !customInstructions}
                      className="px-6 py-3 rounded bg-zinc-950 hover:bg-zinc-800 text-white font-mono font-bold text-[11px] uppercase tracking-widest transition-transform active:scale-95 disabled:opacity-50 cursor-pointer"
                    >
                      Verify Spec Deck
                    </button>
                  </div>
                ...
                >
                  ...
                  <div className="space-y-1.5">
                    <h4 className="text-base font-black text-zinc-950 uppercase tracking-tight">
                      Detailing Diagnostics Form Logged
                    </h4>
                    <p className="text-xs text-zinc-500 font-mono">
                      Your chassis VIN {vin.toUpperCase()} has been submitted.
                    </p>
                  </div>
                  <div className="p-4 bg-zinc-50 rounded border border-zinc-200 text-xs text-zinc-650 leading-relaxed font-mono">
                    Please keep this window open or contact our workshop direct. We have triggered an automatic EPC parts lookup.
                  </div>
